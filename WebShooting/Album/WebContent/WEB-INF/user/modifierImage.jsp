...
<div class="container" style="margin-bottom: 100px; margin-top: 70px;">
	<div class="row justify-content-center">
		<div class="card col-lg-8">
			<form method="post">
				<div class="card-header">Information Image</div>
					<div class="card-body">
						<div class="form-group">
										<label for="">Nom:</label> <input type="text" name="nomAlbum" id=""
											value='<c:out value="${requestScope.infoAlbum.titre }"></c:out>'
											 class="form-control"required="required">
									</div>
									<div class="form-group">
										<label for="">Type:(<c:out value="${requestScope.infoAlbum.description }"></c:out>)</label> <select class="form-control"
											name="type" id="">
